...
namespace BeautySCProject.Common.Helpers
{
    ...
    {
        public static string GetAccountVerificationEmailBody(string content, string des, string link)
        {
            return @$"
...
<![endif]-->
  ...
  <span style=""color: white; font-size: 60px; font-weight: bold;"">BeautySC</span>
</a>
                   <!--[if gte mso 12]>
    </td></tr></table>
<![endif]-->
...
";
        ...
        public static string GetApprovalEmailBody(string content, string des)
        {
            return @$"
<html xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:o=""urn:schemas-microsoft-com:office:office"">
